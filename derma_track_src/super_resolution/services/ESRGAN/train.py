...
def train_model(model_name: str, train_file: str, valid_file: str, eval_file: str, output_path: str, 
    ...
    generator_optimizer = optim.Adam(model.parameters(), lr = 1e-4)
            ...
            for loop_type, dataloader in [("Training", train_loader), ("Validation", val_loader)]:
                ...
                with torch.set_grad_enabled(loop_type == "Training"):
                    ...
                    for low_res, high_res in dataloader:
                        ...
                        fake_image = model(low_res).detach()
    ...
    torch.save({"architecture": "SRGAN", "scale": scale, "color_mode": mode, "invert_color_mode": invert_mode, "model_state_dict": model.state_dict()}, os.path.join(output_path, model_name))
