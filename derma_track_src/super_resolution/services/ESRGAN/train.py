...
def train_model(model_name: str, train_file: str, valid_file: str, eval_file: str, output_path: str, 
    ...
    """
    Trains an ESRGAN super-resolution model using the specified training, validation, and evaluation datasets.
    ...
    discriminator = ESRGANDiscriminator(crop_size = patch_size).to(device)
    ...
    torch.save({"architecture": "ESRGAN", "scale": scale, "color_mode": mode, "invert_color_mode": invert_mode, "need_resize": False,
